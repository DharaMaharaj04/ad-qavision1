...
import Mobtest from "../../assets/images/Mobtest1.gif";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 pt-8 sm:pt-8 md:pt-1 sm:px-4 md:px-28 justify-items-center items-center">
        ...
        variants={containerVariants}
          ...
          <div className="mt-4">
            <motion.p
              className=
                  "text-lg sm:text-lg md:text-2xl  w-5/5 sm:pr-8 py-2 font-inter font-small no-underline align-center text-justify normal-case text-dark"
              initial="hidden"
        animate="visible"
        variants={containerVariants}
            >
